...
def seed_products():
    ...
    product2 = Product(
        owner_id=2, product_name='Nike Women\'s Sneaker Running Shoes', price=122.00, brand='Nike', stock_quantity=100, description='Women\'s running shoes from Nike.')
    product3 = Product(
        owner_id=3, product_name='Nike Women\'s NSW Tight Fleece Varsity', price=50.00, brand='Nike', stock_quantity=5, description='The semi-brushed fleece fabric has a soft, lightweight feel perfect for everyday wear')
